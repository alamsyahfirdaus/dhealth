        ...
        <div class="card card-info card-outline">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="<?= site_url('add/signa') ?>" class="btn btn-tool"><i class="fas fa-plus"></i></a>
            </div>
          </div>
          <div class="card-body">
                ...
                <thead>
                  <tr>
                    ...
                    $thead = array(
                      ...
                      '<th>Kode<span style="color: white;">_</span>Signa</th>',
                      '<th>Nama<span style="color: white;">_</span>Signa</th>',
...
<script type="text/javascript">
  ...
  function delete_data(id) {
    if (confirm('Apakah anda yakin?')) {
      $.getJSON('<?= site_url('delete/signa') ?>/' + id, function(response) {
        if (response.status) {
          table.ajax.reload();
          $('#response-data').html('');
          $(window).scrollTop(0);
